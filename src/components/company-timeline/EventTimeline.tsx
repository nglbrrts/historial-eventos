        ...
        <div className="max-w-[670px] mx-auto pb-20 z-50 inter">
            ...
            <TimelineItem origin="Juan Pérez" time="12:00" type="terms" buttonLabel='Descargar XML' buttonUrl='#'  title="Emitió la factura folio N°21414 a:">
                <div className="w-full px-2 py-1 bg-neutral-100 dark:bg-neutral-700 rounded text-black dark:text-white text-base font-normal ">
                    EMPRESA CONSTRUCTORA SPA • $1.125.737 • <Link onClick={onLinkClick} href="#" className="text-indigo-600 dark:text-indigo-400 text-base font-normal ">Ver factura 🔗</Link>
                </div>
            </TimelineItem>
            <TimelineItem origin="Guou Finance" time="12:00" type="backoffice" tags={['Abono', 'Operación', 'Pronto pago']} title="Abonó la operación de financiamiento Pronto Pago N°352">
                <div className="w-full px-2 py-1 bg-neutral-100 dark:bg-neutral-700 rounded text-black dark:text-white text-base font-normal  flex flex-row justify-between">
                    <div> 12 facturas • $17.345.667 • <Link href="#" className="text-indigo-600 dark:text-indigo-400 text-base font-normal ">Ver operación N°352 🔗</Link>
                    </div>
                    <div>
            ...
            <TimelineItem origin="Juan Pérez" time="12:00" type="simulation" buttonLabel='Reenviar simulación' buttonUrl='#' tags={['Simulación', 'Pronto pago']} title="Creó una simulación de financiamiento Pronto Pago">
                <div className="w-full px-2 py-1 bg-neutral-100 dark:bg-neutral-700 rounded text-black dark:text-white text-base font-normal  flex flex-row justify-between">
                    <div> 12 facturas • $17.345.667 • <Link href="#" className="text-indigo-600 dark:text-indigo-400 text-base font-normal ">Ver simulación N°1251 🔗</Link>
                    </div>
                    <div>
            ...
            <TimelineItem origin="Rolando Peña" time="12:00" type="terms" tags={['Condiciones comerciales', 'Pronto pago']} title="actualizó las condiciones comerciales:">
                <div className="w-full px-2 py-1 bg-neutral-100 dark:bg-neutral-700 rounded text-black dark:text-white text-base font-normal ">
                    Se <b>modifica</b> Pronto Pago cerrado <Link href="#" className="text-indigo-600 dark:text-indigo-400 text-base font-normal ">Ver condiciones 🔗</Link>
                </div>
            </TimelineItem>
            <TimelineItem origin="Rolando Peña" time="12:00" type="terms" tags={['Condiciones comerciales', 'Pronto pago']} title="actualizó las condiciones comerciales:">
                <div className="w-full px-2 py-1 bg-neutral-100 dark:bg-neutral-700 rounded text-black dark:text-white text-base font-normal ">
                    Se <b>habilita</b> Pronto Pago cerrado <Link href="#" className="text-indigo-600 dark:text-indigo-400 text-base font-normal ">Ver condiciones 🔗</Link>
                </div>
            </TimelineItem>
            <TimelineItem origin="Juan Pérez" time="12:00" type="sync" buttonLabel='Volver a extraer data' buttonUrl='#' tags={['Sincronización']} title={<><b>Sincronizó</b> información desde el SII:</>}>
                <div className="w-full h-fit flex-col justify-start items-start gap-1 inline-flex">
                    <div className="w-full px-2 py-1 bg-neutral-100 dark:bg-neutral-700 rounded text-black dark:text-white text-base font-normal ">
                        Se obtuvieron <Link href="#" className="text-indigo-600 dark:text-indigo-400 text-base font-normal ">1.029 facturas 🔗</Link>
                    </div>
                    <div className="w-full px-2 py-1 bg-neutral-100 dark:bg-neutral-700 rounded text-black dark:text-white text-base font-normal ">
                        Se obtuvieron <Link href="#" className="text-indigo-600 dark:text-indigo-400 text-base font-normal ">285 cesiones 🔗</Link>
                    </div>
                    <div className="w-full px-2 py-1 bg-neutral-100 dark:bg-neutral-700 rounded text-black dark:text-white text-base font-normal ">
                        Se actualizaron los  <Link href="#" className="text-indigo-600 dark:text-indigo-400 text-base font-normal ">documentos de TGR 🔗</Link>
                    </div>
                </div>
            </TimelineItem>
