...
type DtesOfertasProps = {
};

const documentos = [
    { folio: '12315', fecha: '03/04/24', company: 'ESTUDIO DE DISEÑO GALGA LIMITADA', rut: '76.860.236-4', monto: '$14.327.976', iva: '$2.722.315 IVA' },
    { folio: '346', fecha: '25/04/24', company: 'ESTUDIO DE DISEÑO GALGA LIMITADA', rut: '76.860.236-4', monto: '$20.639.357', iva: '$3.921.478 IVA' },
    { folio: '2346', fecha: '25/04/24', company: 'ESTUDIO DE DISEÑO GALGA LIMITADA', rut: '76.860.236-4', monto: '$114.919.563', iva: '$21.834.717 IVA' },
    { folio: '468', fecha: '25/04/24', company: 'ESTUDIO DE DISEÑO GALGA LIMITADA', rut: '76.860.236-4', monto: '$71.582.336', iva: '$13.600.644 IVA' },
    { folio: '9945', fecha: '25/04/24', company: 'ESTUDIO DE DISEÑO GALGA LIMITADA', rut: '76.860.236-4', monto: '$13.276.163', iva: '$2.522.471 IVA' },
]

const DtesOfertas: React.FC<DtesOfertasProps> = (props) => {
    return (
                ...
                <tbody className="bg-white dark:bg-neutral-800 inter">
                    {documentos.map((documento) => (
                        <tr className="even:bg-gray-50 dark:even:bg-neutral-900/40 hover:bg-gray-200/40 dark:hover:bg-neutral-700/20 cursor-pointer transition-all">
                            ...
                            <td className="whitespace-nowrap px-3 py-4 text-sm text-neutral-500 dark:text-neutral-300 text-center"><Badge state='financiamiento_directo' /></td>
