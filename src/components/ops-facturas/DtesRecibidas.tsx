            ...
            <table className="min-w-full divide-y divide-gray-300 dark:divide-neutral-700 bg-white dark:bg-neutral-800">
                ...
                <tbody className="bg-white dark:bg-neutral-800 inter">
                    {documentos.map((documento, index) => (
                        <tr key={`${documento.folio}-${documento.fecha}-${index}`} className="even:bg-gray-50 dark:even:bg-neutral-900/40 hover:bg-gray-200/40 dark:hover:bg-neutral-700/20 cursor-pointer transition-all">
